...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'src/__tests__/ec01-shared-institutional-approval.test.ts',
      'src/__tests__/ec01-trusted-normative-checker.test.ts',
      ...
      'src/__tests__/arena-canonical-ux-contract.test.ts',
      'src/__tests__/curriculum-explore-trama-v2-contract.test.ts',
