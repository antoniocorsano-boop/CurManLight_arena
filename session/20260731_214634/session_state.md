...
- Updated: 2026-08-18 15:32:00 +02:00

## Goal
CURR-R2 — 2025 normative corpus completion: contract audit (R2B), minimal projection (R2C), and fixture pilot expansion (R2D).

## Current Subtask
R2E-3 Storia+Geografia 2025 COMPLETE. Added 8 segment arrays + 8 node arrays for storia/geografia 2025, plus lot test (11 tests). Acquisition manifest updated with R2D and R2E lot registry. Next: R2E-4 Matematica+Scienze+Tecnologia.
...
- R2E-3 Storia+Geografia VERIFIED: primaria/secondaria segments and nodes for storia/geografia added, provenance validated, no synthetic links.
...
- [ ] R2E-4+: remaining 2025 lots (MST, linguaggi, trasversali)
...
## Evidence
- Test: 49/49 2025-specific tests PASS
- test:fast: 273/273 PASS
- curriculum-domain: 304/304 PASS
- tsc --noEmit: PASS
- build: PASS
