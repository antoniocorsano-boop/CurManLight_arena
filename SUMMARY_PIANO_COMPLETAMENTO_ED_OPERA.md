# 📊 PIANO DI COMPLETAMENTO, ATTUAZIONE ED OPERA (v1.5.3-GOLD)
...
*Stato del Piano: APPROVATO & PRONTO PER L'INSERIMENTO IN DELIBERA*
...
La terza fase vede i Dipartimenti Disciplinari avviare il lavoro di revisione ed allineamento dei curricoli d'area:
...
* La segreteria compila la Diachiariazione di Accessibilità AgID (.txt) pre-compilata generata dal *Cruscotto PA* e la invia all'AgID entro le scadenze di legge.
...
---
*Rapporto del Piano di Attuazione ed Opera d'Istituto salvato e pronto nel tuo workspace.*  
