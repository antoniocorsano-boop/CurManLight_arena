 ...
 *
 * La versione 1.3 incorpora nello stesso master i GAP/PARTIAL deduplicati emersi
 * dal gate OSA requisito-per-requisito. Il gate è completo esclusivamente come
 * copertura documentale: validazione professionale, revisione verticale e vigenza
 * restano passaggi distinti e aperti.
 */
export const INSTITUTE_CURRICULUM_CURRENT_SOURCE = {
  ...
  sourceRepertory: {
    ...
    alignmentState: 'ALIGNED_TO_MASTER_1_3',
  },
  ...
  normativeAlignment: {
    ...
    status: 'DOCUMENTARY_COVERAGE_COMPLETE_PENDING_HUMAN_VALIDATION',
    osaOneToOneGate: 'COMPLETE_FOR_DOCUMENTARY_COVERAGE',
    osaDocumentaryCoverageComplete: true,
    osaVerifiedIntegrationsMaterializedInMaster13: true,
    osaCompletionClaimScope: 'DOCUMENTARY_ONLY',
    benchmarkSemantics: {
