...
export const TECHNOLOGY_CLASS1_REVIEW_PROPOSALS: Proposal[] = [
  {
    ...
    oldLabel: 'Fonte corrente',
    newLabel: 'Proposta R2 da validare',
    keepLabel: 'Mantieni fonte corrente',
    oldText: 'Osservare oggetti, materiali e strumenti presenti nell’ambiente scolastico e quotidiano, riconoscendone caratteristiche e funzioni; esplorare materiali con semplici attività e misurazioni; rappresentare oggetti, ambienti e percorsi mediante disegni, schemi e modelli elementari.',
    newText: 'Analizzare oggetti semplici riconoscendo bisogno, funzione, parti, materiali, uso e rischi; effettuare misure; svolgere semplici prove comparative; utilizzare gli strumenti del disegno tecnico e realizzare costruzioni geometriche di base; raccogliere e rappresentare informazioni tecniche elementari.',
    contextSummary: 'Obiettivo annuale d’Istituto ricondotto al nucleo fondante «Vedere, osservare e sperimentare». L’audit ha eliminato dal focus il richiamo autonomo all’energia, mantenendo osservazione tecnica, misura, prove e rappresentazione.',
    sourceRefs: commonSourceRefsR2,
    gateId: 'SEC1-05 / TECHNOLOGY_REWORK / R2',
    notes: 'Revisione R2 dopo audit. Le decisioni registrate sulla R1 restano storiche e non sono trasferite a questa formulazione.',
  },
  {
    ...
    oldText: 'Utilizzare risorse e informazioni per progettare e realizzare semplici manufatti o prodotti, seguendo indicazioni e procedure guidate.',
    newText: 'Individuare un problema concreto; formulare requisiti e vincoli; confrontare alternative; rappresentare una soluzione; pianificare materiali, strumenti, fasi e tempi essenziali; prevedere criticità e criteri di verifica.',
    contextSummary: 'Obiettivo annuale d’Istituto ricondotto al nucleo fondante «Prevedere, immaginare e progettare». La formulazione è risultata sostanzialmente solida nell’audit ed è riproposta nella revisione R2 con autorità esplicitata.',
    sourceRefs: commonSourceRefsR2,
    gateId: 'SEC1-05 / TECHNOLOGY_REWORK / R2',
    notes: 'Revisione R2 dopo audit. La formulazione richiede una nuova scelta esplicita anche se il contenuto sostanziale è invariato.',
  },
  {
    ...
    oldText: 'Riconoscere semplici processi di trasformazione di materiali e risorse e comprendere che le scelte tecnologiche producono effetti sull’ambiente e sulle persone; realizzare semplici prodotti seguendo procedure guidate.',
    newText: 'Seguire e documentare procedure; lavorare e assemblare materiali in sicurezza; realizzare un semplice manufatto o modello; verificarlo rispetto allo scopo; riconoscere trasformazioni e fasi di produzione; valutare riuso, riparazione e riciclo.',
    contextSummary: 'Obiettivo annuale d’Istituto ricondotto al nucleo fondante «Intervenire, trasformare e produrre». L’eventuale economia circolare resta un raccordo d’Istituto con sostenibilità ed Educazione civica, non una formulazione nazionale annuale.',
    sourceRefs: commonSourceRefsR2,
    gateId: 'SEC1-05 / TECHNOLOGY_REWORK / R2',
    notes: 'Provenienza corretta dopo audit: riferimento nazionale + annualizzazione d’Istituto + eventuale raccordo trasversale.',
  },
  {
    ...
    contextSummary: 'Asse annuale d’Istituto che integra l’Informatica nei tre nuclei fondanti di Tecnologia. Non costituisce un quarto nucleo nazionale autonomo e supera il semplice uso di applicazioni per introdurre funzionamento dei sistemi, dati e processi.',
    sourceRefs: commonSourceRefsR2,
    gateId: 'SEC1-05 / TECHNOLOGY_REWORK / R2',
    notes: 'Conoscenze collegate: ingresso, elaborazione, memoria e uscita; hardware e software; sistema operativo e file; dati e informazioni; algoritmo; Internet, Web e servizi; autenticazione, dati personali e attendibilità.',
  },
  {
    ...
    oldLabel: 'Stato corrente',
    newLabel: 'Raccordo R2 da validare',
    keepLabel: 'Mantieni stato corrente',
    oldText: 'La classe prima applica il nuovo quadro 2025. Le classi seconda e terza proseguono nel regime transitorio riferito al quadro 2012: il nuovo impianto non deve essere applicato retroattivamente alle coorti già in prosecuzione.',
    ...
    contextSummary: 'La matrice R2 mantiene il nuovo quadro per la classe prima e il regime transitorio per seconda e terza. Gli elementi digitali aggiuntivi delle coorti in transizione restano qualificati come proposta o raccordo d’Istituto fino alla verifica puntuale di provenienza.',
    sourceRefs: [
