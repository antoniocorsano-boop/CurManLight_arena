...
export const ARENA_PROCESS_PIPELINE: readonly ArenaProcessContract[] = [
  ...
  },
  {
    ...
    input: ['institutional-decision-receipt', 'target-canonical-version'],
...
export const ARENA_ROLE_EXPERIENCES: readonly ArenaRoleExperienceContract[] = [
  {
    ...
    primaryQuestions: [
      'Quale curricolo si applica?',
      'Cosa è cambiato?',
      'Quali evidenze lo sostengono?',
      'Cosa posso proporre?',
      'Cosa posso trasferire alla pianificazione?',
    ],
  ...
  },
  {
    ...
    primaryQuestions: [
      ...
      'Quali proposte sono pronte da esaminare?',
      'Le evidenze sono sufficienti?',
      'Cosa deve passare al referente?',
    ],
  ...
  },
  {
    ...
    primaryQuestions: [
      'Dove sono i gap e le coperture mancanti?',
      'Quali proposte sono bloccate?',
      'Quali fonti o evidenze richiedono verifica?',
      'Cosa è pronto per la decisione istituzionale?',
    ],
    capabilities: ['CURRICULUM_READ', 'CURRICULUM_PROPOSE', 'REVISION_REVIEW', 'DOCUMENT_PREPARE', 'DOCUMENT_EXPORT'],
    queueStates: ['TO_READ', 'TO_VERIFY', 'TO_REVIEW', 'COMPLETED'],
  },
  {
    ...
    primaryQuestions: [
      'Che cosa cambia?',
      'Perché cambia?',
      'Quali evidenze e revisioni lo sostengono?',
      'Quale decisione devo assumere?',
    ],
  ...
  },
  {
    ...
    primaryQuestions: [
      'Il processo è pronto per la decisione?',
      'Quali blocchi istituzionali restano?',
      'Le fonti, versioni e ricevute sono tracciabili?',
    ],
  ...
  },
  {
    ...
    primaryQuestions: [
      'Il workspace è integro?',
      'Membership, storage, backup e restore sono operativi?',
      'La release pubblicata è verificabile?',
    ],
