  ...
  return (
    ...
    >
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 lg:grid-cols-4">
        ...
        <MetricCard label="Pronte per decisione" value={snapshot.proposalReadyForDecision} note={`${snapshot.decisionsRecordedLocal} decisioni locali registrate`} />
      </div>
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-2">
        ...
        {(snapshot.proposalInReview > 0 || snapshot.proposalReadyForDecision > 0) && (
