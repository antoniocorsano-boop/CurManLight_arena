...
export function MobileBottomNav({ activeTab, pendingCount, handleTabSwitch }: MobileBottomNavProps) {
  ...
  return (
    <nav
      className="fixed left-3 right-3 z-50 grid min-h-[4.25rem] grid-cols-5 items-stretch gap-0.5 rounded-[1.4rem] border border-slate-200/90 bg-white/95 p-1.5 shadow-[0_12px_36px_rgba(15,23,42,0.18)] backdrop-blur-xl md:hidden"
