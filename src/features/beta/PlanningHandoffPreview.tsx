...
export function PlanningHandoffPreview() {
  ...
  const summaryStatus = preview.status === 'blocked'
    ...
    : `${curriculumStateLabel(preview.handoff.curricularContext.curriculumState)} · PREVIEW_ONLY`;
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <strong className="block text-xs uppercase tracking-wider text-slate-600">
                Passaggio alla progettazione
              </strong>
              <p className="mt-1 font-semibold text-slate-800">{summaryStatus}</p>
              <p className="mt-1 text-xs text-slate-500">Apri i dettagli per contesto, requisiti e provenienza.</p>
            </div>
          </div>
        </summary>
            ...
            <>
              <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                  <strong className="block text-xs uppercase text-slate-500">Contesto</strong>
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                  <strong className="block text-xs uppercase text-slate-500">Baseline risultante</strong>
