...
describe('institutional curriculum source register', () => {
  it('binds ALL-CURR-A 1.1 to the current master without creating a competing baseline', () => {
  ...
  it('preserves one explicit document chain for baseline, control, repertory and provenance', () => {
    ...
    expect(INSTITUTE_CURRICULUM_SOURCE_CHAIN[1].role).toBe(
  ...
  it('registers the authoritative sources used by master 1.1 with unique codes and verifiable locators', () => {
